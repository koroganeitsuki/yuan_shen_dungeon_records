...
const DataStore = {
    ...
    characters: [
         // 其他角色
        { id: 'Odette', name: '奥黛塔', avatar: access + 'Avatar/UI_AvatarIcon_Odette.webp', element: '冰' },
        { id: 'Lohen', name: '阿罗夏', avatar: access + 'Avatar/UI_AvatarIcon_Alyosha.webp', element: '雷' },
        { id: 'Marionette', name: '桑多涅', avatar: access + 'Avatar/UI_AvatarIcon_MarionetteNew.webp', element: '冰' },
        ...
        { id: 'Jahoda', name: '雅珂达', avatar: access + 'Avatar/UI_AvatarIcon_Jahoda.png', element: '风' },
        ...
        { id: 'valeisha', name: '瓦雷莎', avatar: access + 'Avatar/UI_AvatarIcon_Varesa.png', element: '雷' },
        ...
        { id: 'Kokomi', name: '珊瑚宫心海', avatar: access + 'Avatar/UI_AvatarIcon_Kokomi.png', element: '水' },
        ...
        { id: 'Shenhe', name: '申鹤', avatar: access + 'Avatar/UI_AvatarIcon_Shenhe.png', element: '冰' },
        ...
        { id: 'bingzhu', name: '冰主', avatar: access + 'Avatar/UI_AvatarIcon_PlayerBoy.png', element: '冰' },
